...
namespace adminlte
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            //string sb = "~/Scripts/sb/vendor/";
            //string sbvendor = "vendor/";
            bundles.Add(new ScriptBundle("~/bundles/jquery")
                .Include("~/Scripts/sb/vendor/jquery/jquery.min.js"));


            bundles.Add(new ScriptBundle("~/bundles/jqueryval").Include(
                        "~/Scripts/sb/js/validate/jquery.validate*"));

            bundles.Add(new ScriptBundle("~/bundles/lib")
                .Include("~/Scripts/sb/vendor/bootstrap/js/bootstrap.bundle.min.js")
                .Include("~/Scripts/sb/vendor/jquery-ui/jquery-ui.min.js")
                .Include("~/Scripts/sb/vendor/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js")
                .Include("~/Scripts/sb/vendor/jquery-easing/jquery.easing.min.js"));

            //bundles.Add(new ScriptBundle("~/bundles/jquery")
            // .Include("~/Scripts/sb/vendor/jquery/dist/jquery.min.js"));

       


            bundles.Add(new ScriptBundle("~/bundles/sbjs")
                .Include("~/Scripts/sb/js/sb-admin-2.min.js"));

            //bundles.Add(new ScriptBundle("~/bundles/mask")
            //    .Include("~/Scripts/sb/vendor/input-mask/jquery.inputmask.js")
            //    .Include("~/Scripts/sb/vendor/input-mask/jquery.inputmask.date.extensions.js")
            //    .Include("~/Scripts/sb/vendor/input-mask/jquery.inputmask.extensions.js")
            //    .Include("~/Scripts/sb/vendor/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js")
            //    );


            bundles.Add(new StyleBundle("~/Content/css")
                    .Include("~/Scripts/sb/vendor/fontawesome-free/css/all.min.css")
                    .Include("~/Scripts/sb/vendor/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css")
                    .Include("~/Content/sb/css/sb-admin-2.min.css"));
