...
namespace adminlte.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            //CoutryIPModel pais = new CoutryIPModel();

            //pais = await ValidarPais(ip);
            //ViewBag.pais = pais;
            ...
            switch (result)
            {
                ...
                default:
                    ModelState.AddModelError("", "Intento erroneo de ingreso.");
                    return View(model);
            }
        }
        ...
        [AllowAnonymous]
        [HttpPost]
        public  ActionResult SendOTP(string data)
        {
            var userId = data;//await SignInManager.GetVerifiedUserIdAsync();
            if (userId == null)
            {
                return View();
            }
        ...
        public async Task<ActionResult> SendCode(string returnUrl)
        {
            ...
            return View(new SendCodeViewModel { SelectedProvider = "PhoneCode", ReturnUrl = returnUrl });


            // return RedirectToAction("SendCode", new SendCodeViewModel { SelectedProvider = "PhoneCode", ReturnUrl = returnUrl });
        }
